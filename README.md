# Домашнее задание к занятию 2 «Кластеризация и балансировка нагрузки» - Минин Александр
...
frontend example  # секция фронтенд
        mode http
        bind :8080
	acl ACL_my_site hdr(host) -i example.local
	use_backend web_servers if ACL_my_site
